  ...
  Future<void> onInit() async {
    ...
    await getSettingsData().then((value) {
      if (value?.success == 'success') {
        ...
        */
        ConstantColors.primary = const Color.fromARGB(0, 4, 118, 211);
        Constant.distanceUnit = "KM";
        Constant.appVersion = "1.0";
        Constant.decimal = 2;
        Constant.taxType = 'Percentage';
        Constant.taxName = 'Tax';
        Constant.taxValue = 0;
        Constant.currency = "\$";
        Constant.kGoogleApiKey = "AIzaSyBwKgjsCUvstJD_8KuJfqa68-q6gOIA280";
        Constant.contactUsEmail = "info@navi.enterprises";
        Constant.contactUsAddress = "San José - Costa Rica";
        Constant.contactUsPhone = "(506)87723422";
        Constant.rideOtp = "yes";
      }
    });
    super.onInit();
  }
